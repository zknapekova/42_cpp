...
int main( void ) {
	...
	std::cout << "[point inside the triangle]: result is " << res1 << std::endl;
	
	//point outside the triangle
	bool res2 = bsp(a, b, c, Point(5.0f, 5.0f));
	std::cout << "[point outside the triangle]: result is " << res2 << std::endl;
	
	//point is one of the vertices
	bool res3 = bsp(a, b, c, Point(0.0f, 0.0f));
	std::cout << "[point is one of the vertices]: result is " << res3 << std::endl;
	
	//point is on the edge
	bool res4 = bsp(a, b, c, Point(3.0f, 0.0f));
	std::cout << "[point is on the edge]: result is " << res4 << std::endl;
	return 0;
}
